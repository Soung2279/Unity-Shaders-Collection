...
//简陋的版本信息
static class Constantsb
{
    public const string Sd_Version= "Built_in_Standard_V1.8.7_beta";
...
public class Soung_ShaderGUI_Built_in : ShaderGUI
{
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
    {
        ...
        //提供更新说明
        #region [更新时间]
        GUILayout.Label($"由Soung制作, 更新时间{Constantsb.UpdateTime}", GUILayout.Width(300), GUILayout.Height(20)); //提示语句
        #endregion


        #region [版本号]
        if (GUILayout.Button($"当前:{Constantsb.Sd_Version}")) //提示语句
        {
            string shaderinfos = $"_ShaderINFO_\n Version: {Constantsb.Sd_Version}\nShaderModel:{Constantsb.Sd_Model}\nType: {Constantsb.Sd_Type}";
            Debug.Log($"<color=#66ccff><i>{shaderinfos}</i></color>");
            string updateurl = $"更新地址：\n{Constantsb.UpdateWebSite}";
