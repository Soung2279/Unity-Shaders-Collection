...
{
    public const string Sd_Version= "URP_Standard_V1.8.7_beta";
    public const string Sd_Model = "3.5";
    public const string Sd_Type = "UniversalUnlit, Forward";
    public const string UpdateTime = "2023.12.29";
    public const string UpdateWebSite = "https://github.com/Soung2279/Unity-Shaders-Collection";
}

public class Soung_ShaderGUI_URP : ShaderGUI
{
    ...
    static bool _Mask_2_Foldout = false;
    ...
    MaterialProperty Mask_Tex2 = null;

    MaterialProperty Mask_Tex_A_R2 = null;

    MaterialProperty Mask_Tex_ClampSwitch2 = null;

    MaterialProperty Mask_Tex_Rotator2 = null;

    MaterialProperty Mask_Tex_U_speed2 = null;

    MaterialProperty Mask_Tex_V_speed2 = null;
    #endregion
    ...
    MaterialProperty LGTexSwitch = null;

    MaterialProperty LiuguangTex_P = null;

    MaterialProperty LG_Tex_Rotator = null;

    MaterialProperty LGColor = null;

    MaterialProperty UseLGTexColor = null;

    MaterialProperty LGTex_U_Speed = null;

    MaterialProperty LGTex_V_Speed = null;
    #endregion
    ...
    public void FindProperties(MaterialProperty[] props)
    {
        ...
        Mask_Tex2 = FindProperty("_Mask_Tex2", props);

        Mask_Tex_A_R2 = FindProperty("_Mask_Tex_A_R2", props);

        Mask_Tex_ClampSwitch2 = FindProperty("_Mask_Tex_ClampSwitch2", props);

        Mask_Tex_Rotator2 = FindProperty("_Mask_Tex_Rotator2", props);

        Mask_Tex_U_speed2 = FindProperty("_Mask_Tex_U_speed2", props);

        Mask_Tex_V_speed2 = FindProperty("_Mask_Tex_V_speed2", props);
        #endregion 
        ...
        LGTexSwitch = FindProperty("_LGTexSwitch", props);

        LiuguangTex_P = FindProperty("_LiuguangTex_P", props);

        LG_Tex_Rotator = FindProperty("_LG_Tex_Rotator", props);

        LGColor = FindProperty("_LGColor", props);

        UseLGTexColor = FindProperty("_UseLGTexColor", props);

        LGTex_U_Speed = FindProperty("_LGTex_U_Speed", props);

        LGTex_V_Speed = FindProperty("_LGTex_V_Speed", props);
        #endregion 
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
    {
        ...
        //提供更新说明
        #region [更新时间]
        GUILayout.Label($"由Soung制作, 更新时间{Constants.UpdateTime}", GUILayout.Width(300), GUILayout.Height(20)); //提示语句
        #endregion

        #region [版本号]
        if (GUILayout.Button($"当前:{Constants.Sd_Version}")) //提示语句
        {
            string shaderinfos = $"_ShaderINFO_\n Version: {Constants.Sd_Version}\nShaderModel:{Constants.Sd_Model}\nType: {Constants.Sd_Type}";
            Debug.Log($"<color=#66ccff><i>{shaderinfos}</i></color>");
            string updateurl = $"更新地址：\n{Constants.UpdateWebSite}";
        ...
        if (Remap_Tex.textureValue != null)
        {
            ...
            _Remap_Foldout = Foldout(_Remap_Foldout, "颜色叠加贴图(RampTex)");
        ...
        {
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            _Remap_Foldout = Foldout2(_Remap_Foldout, "颜色叠加贴图(RampTex)");
        ...
        #region [遮罩2部分]
        if (Mask_Tex2.textureValue != null)
        {
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);

            _Mask_2_Foldout = Foldout(_Mask_2_Foldout, "遮罩贴图2(MaskTex2)");
        ...
        {
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            _Mask_2_Foldout = Foldout2(_Mask_2_Foldout, "遮罩2贴图(MaskTex2)");
        ...
        //遮罩图2具体显示内容
        void GUI_Mask2(Material material)

        { 
        

            m_MaterialEditor.TexturePropertySingleLine(new GUIContent("遮罩贴图2"), Mask_Tex2);
            ...
            if (Mask_Tex2.textureValue != null)
            {
                ...
                m_MaterialEditor.TextureScaleOffsetProperty(Mask_Tex2);


                EditorGUILayout.BeginVertical(EditorStyles.helpBox);
                m_MaterialEditor.ShaderProperty(Mask_Tex_A_R2, "切换通道");

                //疑问：横向的框怎么改长度
                m_MaterialEditor.ShaderProperty(Mask_Tex_Rotator2, "贴图旋转");

                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.PrefixLabel("切换贴图重铺");
                #region [遮罩贴图重铺]
                if (material.GetFloat("_Mask_Tex_ClampSwitch2") == 0)
                {
                    if (GUILayout.Button("重铺", shortButtonStyle))
                    {
                        material.SetFloat("_Mask_Tex_ClampSwitch2", 1);
                    }
                ...
                else
                {
                    if (GUILayout.Button("不重铺", shortButtonStyle))
                    {
                        material.SetFloat("_Mask_Tex_ClampSwitch2", 0);
                    }
                }
                EditorGUILayout.EndVertical();
                #endregion
                ...
                EditorGUILayout.EndVertical();
                    ...
                    EditorGUILayout.BeginVertical(EditorStyles.helpBox);
                    m_MaterialEditor.ShaderProperty(Mask_Tex_U_speed2, "横向流动速度");
                    m_MaterialEditor.ShaderProperty(Mask_Tex_V_speed2, "纵向流动速度");
                    EditorGUILayout.EndVertical();
        ...
        { 
            ...
            m_MaterialEditor.TexturePropertySingleLine(new GUIContent("流光纹理"), LiuguangTex, LGColor);
            ...
            if (LiuguangTex.textureValue != null)
            {
                ...
                EditorGUILayout.BeginVertical(EditorStyles.helpBox);
                m_MaterialEditor.ShaderProperty(LGTexSwitch, "流光开关");
                m_MaterialEditor.ShaderProperty(LiuguangTex_P, "切换通道");
                EditorGUILayout.EndVertical();
                ...
                {
                    if (GUILayout.Button("禁用", shortButtonStyle))
                    {
                ...
                //疑问：横向的框怎么改长度
                m_MaterialEditor.ShaderProperty(LG_Tex_Rotator, "贴图旋转");

                    EditorGUILayout.BeginVertical(EditorStyles.helpBox);
                    m_MaterialEditor.ShaderProperty(LGTex_U_Speed, "横向流动速度");
                    m_MaterialEditor.ShaderProperty(LGTex_V_Speed, "纵向流动速度");
                    EditorGUILayout.EndVertical();
