...
Shader "A201-Shader/Built-in/特殊制作/双面材质(面具)"
{
	Properties
	{
		...
		[Header(BackTex)][NoScaleOffset]_BackTex("背面纹理", 2D) = "white" {}
		_BackTilnSpeed("背面重铺与速率", Vector) = (1,1,0.2,0)
		[Header(NoiseTex)][NoScaleOffset]_NoiseTex("扭曲贴图", 2D) = "white" {}
		_NoisePwr("扭曲强度", Float) = 0.2
		_NoiseTilnSpeed1("扭曲重铺与速率", Vector) = (1,1,0.2,0)
		[Header(AddTex)][NoScaleOffset]_AddTex("叠加贴图", 2D) = "black" {}
...
Node;AmplifyShaderEditor.ColorNode;36;-228.9193,1105.834;Inherit;False;Property;_AddColor;叠加颜色;9;1;[HDR];Create;False;0;0;0;False;0;False;1,1,1,1;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;2;-522.687,-58.69663;Inherit;True;Property;_MainTexU;正面纹理;0;1;[Header];Create;False;1;FrontTex;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;32;-791.1195,811.7097;Inherit;True;Property;_NoiseTex;扭曲贴图;5;2;[Header];[NoScaleOffset];Create;False;1;NoiseTex;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;12;-648.8035,472.166;Inherit;True;Property;_BackTex;背面纹理;3;2;[Header];[NoScaleOffset];Create;False;1;BackTex;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;45;-739.1469,-34.61597;Inherit;False;0;2;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;33;-316.0772,912.159;Inherit;True;Property;_AddTex;叠加贴图;8;2;[Header];[NoScaleOffset];Create;False;1;AddTex;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=71CD420F1E4D1786A0EF6EEFED0ACB619728F5E2