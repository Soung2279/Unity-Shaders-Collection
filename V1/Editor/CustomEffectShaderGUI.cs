...
public class CustomEffectShaderGUI : ShaderGUI
{
    ...
    //溶解
    #region
    MaterialProperty dissolveMode, reverseDissolve, dissolveTex, dissolveFactor, dissolveHardness;
    ...
    //Stencil
    MaterialProperty stencilRef, stencilComp, stencilOp;
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
    {
        ...
        if (dissolveModeChoose == 1 || dissolveModeChoose == 2)
        {
            ...
            materialEditor.ShaderProperty(reverseDissolve, "反向溶解");
