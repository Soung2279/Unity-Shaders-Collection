...
public class ShaderGUI_AllEffect : ShaderGUI
{
    ...
    //软粒子开关
    MaterialProperty SOFT_PARTICLES_ON = null;
    //软粒子值
    ...
    //遮罩流动模式 | Material or Custom2.xy
    MaterialProperty MaskTexFlowMode = null;
    //反向遮罩
    ...
    public void FindProperties(MaterialProperty[] props)
    {
        ...
        SOFT_PARTICLES_ON = FindProperty("_SOFT_PARTICLES_ON", props);
        ...
        MaskTexFlowMode = FindProperty("_MaskTexFlowMode", props);
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
    {
        ...
        void GUI_Base(Material material)
        {
            ...
            // GPU Instancing控制功能区
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.PrefixLabel("启用 GPU Instancing");
