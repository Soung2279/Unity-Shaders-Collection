Shader "A201-Shader/Built-in/进阶功能/简易卡通着色器"
{
    Properties
    {
        [Header(BaseColor)]
        ...
        _LightCutoff("光照范围", Range(0,1)) = 0.5
        _ShadowBands("阴影过渡", Range(1,4)) = 1

        [Header(Specular)]
        _SpecularMap("高光反射", 2D) = "white" {}
