...
Shader "A201-Shader/特殊制作/屏幕扭曲额外遮罩_FxDis"
{
	Properties
	{
		[Header(Normal)]
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 uv1_DistortionTex = i.uv2_texcoord2 * _DistortionTex_ST.xy + _DistortionTex_ST.zw;
				...
				float2 staticSwitch34 = uv1_DistortionTex;
			#else
...
Node;AmplifyShaderEditor.StaticSwitch;34;-2781.448,-152.9128;Float;False;Property;_Distortion2UV;Distortion2UV;5;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
