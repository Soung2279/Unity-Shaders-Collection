...
Shader "A201-Shader/特殊制作/菲涅尔叠加颜色_HovlIce"
{
	Properties
	{
		_MainTex("主贴图", 2D) = "white" {}
		_Color("主颜色", Color) = (0.02352941,0.2055747,1,1)
		_UpColor("上叠颜色", Color) = (0.4575472,0.7381514,1,1)
		_ColorPosition("颜色过渡", Range( 0 , 1)) = 0.35
		_Emission("自发光强度", Float) = 1
		[HDR]_FresnelColor("菲涅尔颜色", Color) = (1,1,1,1)
		_FresnelPower("菲涅尔强度", Float) = 6
		_FresnelScale("菲涅尔过渡值", Float) = 1
