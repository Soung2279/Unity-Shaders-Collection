Shader "A201-Shader/特殊制作/屏幕扭曲制作_HovlDistortion"
{
	Properties
	{
        _WebSite("使用方法：用一张面片作为扭曲范围，更改扭曲强度或制作放大缩小得到屏幕扭曲效果", Int) = 2023
		[Header(__________________________________________________________________________________________)]
		_NormalMap("法线贴图", 2D) = "bump" {}
		_Distortionpower("扭曲强度", Float) = 0.05
		_InvFade ("软粒子值", Range(0.01,3.0)) = 1.0
	}
